...
class MockDatabase {
  ...
  private initializePermittingOfficerMockData() {
    ...
    const mockApplications: PermitApplication[] = [
      // DRAFT APPLICATIONS (2) - Unsubmitted
      {
        id: "app_draft_001",
      ...
      // PENDING APPLICATIONS (2) - Pending approval
      {
        id: "app_pending_001",
      ...
      // APPROVED APPLICATIONS (2) - Ready for permit printing
      {
        id: "app_approved_001",
      ...
      // REJECTED APPLICATIONS (2) - For testing rejected comments printing
      {
        id: "app_rejected_001",
    ...
    this.applicationCounter = 25 // Update counter to avoid conflicts
  }
