  ...
  private initializeMockData() {
    ...
    const mockApplications: PermitApplication[] = [
      // DRAFT APPLICATIONS (Stage 0) - 2 applications
      {
        ...
        emailAddress: "thomas.mutasa@email.com",
      ...
      },
      {
        ...
        emailAddress: "jennifer.chikwanha@email.com",
      ...
      // SUBMITTED APPLICATIONS (Stage 2 - Chairman Review) - 2 applications
      {
        ...
        cellularNumber: "+263771234567",
        emailAddress: "john.mukamuri@email.com",
        permitType: "water_abstraction",
        waterSource: "borehole",
      ...
      },
      {
        ...
        cellularNumber: "+263772345678",
        emailAddress: "mary.chikwanha@email.com",
      ...
      // UNDER REVIEW APPLICATIONS (Stage 3 - Catchment Manager Review) - 2 applications
      {
        ...
        emailAddress: "peter.moyo@email.com",
        permitType: "irrigation",
        waterSource: "borehole",
        intendedUse: "Small scale irrigation",
        numberOfBoreholes: 1,
      ...
      },
      {
        ...
        emailAddress: "grace.nyamande@email.com",
        permitType: "commercial_use",
        waterSource: "river",
      ...
      // TECHNICAL REVIEW APPLICATIONS (Stage 4 - Catchment Chairperson Review) - 2 applications
      {
        ...
        emailAddress: "james.sibanda@email.com",
      ...
      },
      {
        ...
        emailAddress: "linda.madziva@email.com",
        permitType: "commercial_use",
        waterSource: "river",
      ...
      // APPROVED APPLICATIONS (Ready for Permit Printing) - 2 applications
      {
        id: "app_approved_001",
      ...
      },
      {
        ...
        cellularNumber: "+263774567890",
        emailAddress: "grace.mukamuri@email.com",
        permitType: "irrigation",
        waterSource: "borehole",
        intendedUse: "Small scale irrigation",
        numberOfBoreholes: 1,
      ...
      // REJECTED APPLICATIONS - 2 applications
      {
        id: "app_rejected_001",
      ...
      },
      {
        ...
        cellularNumber: "+263777890123",
        emailAddress: "david.madziva@email.com",
        permitType: "commercial_use",
        waterSource: "borehole",
    ...
    const mockComments: WorkflowComment[] = [
      // Comments for submitted applications (Stage 2 - Chairman Review)
      {
        id: "comment_submitted_001",
        applicationId: "app_submitted_001",
        userId: "1",
        userType: "permitting_officer",
        comment:
          "Application received and under initial review. All required documents submitted. Forwarding to Chairman for technical assessment.",
        stage: 1,
        createdAt: new Date("2024-03-01"),
        isRejectionReason: false,
      },
      {
        id: "comment_submitted_002",
      ...
      // Comments for under review applications (Stage 3)
      {
      ...
      },
      {
        ...
        userType: "chairperson",
        comment:
          "Technical review completed. Water allocation is within sustainable limits. Forwarding to catchment manager for final assessment.",
        stage: 2,
      ...
      },
      {
        ...
        userId: "1",
        userType: "permitting_officer",
        comment: "Aquaculture application reviewed. Water quality requirements and discharge plans assessed.",
        stage: 1,
      ...
      },
      {
        ...
        userType: "chairperson",
        comment:
          "Environmental impact assessment completed. Aquaculture operations approved for catchment manager review.",
        stage: 2,
        createdAt: new Date("2024-02-25"),
        isRejectionReason: false,
      },

      // Comments for technical review applications (Stage 4)
      {
      ...
      },
      {
        ...
        userId: "3",
        userType: "catchment_manager",
        comment: "Catchment impact assessment in progress. Reviewing cumulative water allocation effects.",
        stage: 3,
        createdAt: new Date("2024-02-15"),
        isRejectionReason: false,
      },
      ...
      // Comments for approved applications
      {
        ...
        userId: "1",
        userType: "permitting_officer",
        comment: "Application reviewed and found to be complete. All required documentation submitted.",
        stage: 1,
      ...
      },
      {
        ...
        userType: "chairperson",
        comment:
          "Technical review completed. Water allocation is within sustainable limits. Environmental impact is minimal.",
        stage: 2,
      ...
      },
      {
        ...
        userId: "3",
        userType: "catchment_manager",
        comment: "Final catchment assessment completed. All conditions met. Approved for permit issuance.",
        stage: 3,
        createdAt: new Date("2024-02-10"),
        isRejectionReason: false,
      },
      {
        ...
        userId: "4",
        userType: "catchment_chairperson",
        comment: "Final approval granted. Application meets all regulatory requirements. Permit ready for printing.",
        stage: 4,
        createdAt: new Date("2024-02-15"),
        isRejectionReason: false,
      },
      ...
      },
      {
        ...
        userType: "chairperson",
        comment:
          "REJECTION: After comprehensive review, this application is rejected due to: 1) Insufficient environmental impact mitigation measures, 2) Potential contamination risk to surface water sources, 3) Excessive water allocation request exceeding sustainable limits. Applicant may resubmit with comprehensive environmental management plan and reduced water allocation request.",
        stage: 2,
        createdAt: new Date("2024-02-10"),
      ...
      },
      {
        ...
        userId: "1",
        userType: "permitting_officer",
        comment: "Commercial car wash application reviewed. Water usage and discharge requirements assessed.",
        stage: 1,
      ...
      },
      {
        ...
        userType: "chairperson",
        comment:
          "REJECTION: Application rejected due to: 1) Inadequate wastewater treatment plan, 2) High water allocation for small land area, 3) Potential groundwater contamination from chemical runoff. Please resubmit with proper wastewater treatment system and reduced water allocation.",
        stage: 2,
        createdAt: new Date("2024-02-05"),
        isRejectionReason: true,
      },
    ...
    const mockLogs: ActivityLog[] = [
      {
        ...
        details: "Draft application created by Thomas Mutasa for domestic water use",
      ...
      },
      {
        ...
        applicationId: "app_submitted_001",
        details: "Water extraction application submitted by John Mukamuri for commercial farming",
      ...
      },
      {
        ...
        applicationId: "app_approved_001",
        details: "Application MC2024-0007 approved for permit issuance by Sarah Wilson",
      ...
      },
      {
        ...
        applicationId: "app_rejected_001",
        details: "Application MC2024-0009 rejected due to environmental concerns - Michael Brown",
