  ...
  return (
    <div
      ...
      style={{
        ...
        margin: "0 auto",
        padding: "0.3in 0.75in 0.4in 51.1pt",
    ...
    >
      ...
      <div className="mb-4">
        <table className="w-full text-xs" style={{ borderCollapse: "collapse" }}>
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((index) => {
              const borehole = permitData.boreholeDetails[index - 1]
              return (
                <tr key={index}>
                  <td className="border border-black p-1 text-center font-bold">{index}</td>
                  <td className="border border-black p-1 text-center">{borehole?.boreholeNumber || ""}</td>
                  <td className="border border-black p-1 text-center">
                    {borehole?.allocatedAmount.toLocaleString() || ""}
                  </td>
                  ...
                  <td className="border border-black p-1 text-center">{borehole?.waterSampleFrequency || ""}</td>
                </tr>
              )
            })}
          </tbody>
